...
**Instrument utility (Phase 0–2, 2026-09-03):** Simple dock is Shield / Home / Exchange; Learn is absorbed onto Shield's picker. Home dial is holdings-gated, not mode-gated. Exchange is the swap ticket (quote tap opens route inspector; yield annotates the quote). Rails in `docs/design-language.md` §5 — fail = revert.
