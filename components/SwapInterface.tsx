...
>(function SwapInterface(
  ...
  // Get token balances
  const { balances: tokenBalances, refreshBalances, isMockData } = useStablecoinBalances(
    address || ""
  );
        ...
        {address && isMockData && (
          <div className="mb-4 bg-amber-50 border border-amber-200 rounded-lg p-3 shadow-sm animate-pulse-subtle">
            <div className="flex items-start">
              <div className="flex-shrink-0 bg-amber-100 rounded-full p-1.5 mr-2">
              ...
              <div className="flex-1">
                <p className="text-xs text-amber-800 font-medium">
                  Simulation Mode: Connect to Celo or Arc for real swaps.
                </p>
                <div className="mt-2 flex space-x-2">
                  <button
                    ...
                    className="bg-amber-600 hover:bg-amber-700 text-white text-[10px] font-bold py-1 px-2 rounded transition-colors shadow-sm"
                  >
                    Celo
                  </button>
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-bold py-1 px-2 rounded transition-colors shadow-sm"
                  >
                    Arc Testnet
                  </button>
                </div>
