    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-10 text-center relative overflow-hidden">
            ...
            >
                ...
                <div className="size-32 bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl flex items-center justify-center border border-gray-100 dark:border-gray-700 relative z-10 transition-transform hover:scale-105 duration-500">
                    <motion.div
            ...
            >
                <h2 className="text-4xl font-[900] tracking-tight text-gray-900 dark:text-white mb-4 leading-tight">
                    Secure Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Wealth</span>
                </h2>
                <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-sm mx-auto leading-relaxed font-medium">
            ...
            >
                <motion.button
                    onClick={onContinue}
                    className="w-full px-8 py-5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-lg font-black rounded-3xl shadow-[0_20px_40px_-10px_rgba(0,0,0,0.3)] active:scale-95 transition-all"
                ...
                {onSkip && (
                    <button
                        onClick={onSkip}
                        className="w-full px-6 py-3 text-sm font-[800] text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors uppercase tracking-widest"
                    >
                        Skip to App
                    </button>
                )}
