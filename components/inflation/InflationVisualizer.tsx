          ...
          <div className="relative flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white font-bold text-[13px] leading-tight">
                By holding tokenized gold (PAXG), you preserve <span className="text-emerald-400">${wealthPreserved.toFixed(2)}</span> in wealth that would otherwise be lost to inflation.
              </p>
            </div>
          </div>
        </div>
