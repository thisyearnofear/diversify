            ...
            <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className={`font-bold text-blue-800 dark:text-blue-200 ${isBeginner ? "text-xs" : "text-xs"}`}>
                            {isBeginner 
                ...
                {!isBeginner && (
                    <button
                        onClick={onAskAI}
                        className="text-blue-600 dark:text-blue-300 text-xs px-1.5 py-0.5 bg-blue-100 dark:bg-blue-800 rounded hover:bg-blue-200 dark:hover:bg-blue-700 transition-colors flex-shrink-0 whitespace-nowrap"
                    >
                        More →
                    </button>
                )}
