...
export function serializePurchaseCycle(doc: IPurchaseCycle): PurchaseCycleRecord {
  ...
  return {
    ...
    cycleProtectionExecutionStatus: doc.cycleProtectionExecutionStatus,
    cycleProtectionExecutedAt: doc.cycleProtectionExecutedAt?.toISOString(),
    cycleProtectionTxHash: doc.cycleProtectionTxHash,
    cycleProtectionError: doc.cycleProtectionError,
    status: doc.status,
