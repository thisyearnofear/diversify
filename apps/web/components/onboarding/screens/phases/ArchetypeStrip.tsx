 ...
 *
 * One FlickScrollRow (the §5 flick grammar): 2 archetypes or all 8 fit the
 * same fixed stage without growing it. The active card's coin flips
 ...
 * inside the FlickScrollRow provider's tree; a hook call in the strip
    ...
    >
      {ids.map((id) => (
        <ArchetypeCard
          ...
          isDimmed={activeId !== null && activeId !== id}
          onSelect={onSelect}
        />
      ))}
    </FlickScrollRow>
