...
// The Arc rail follows the settlement env: 5042 on mainnet, 5042002 on testnet.
const ARC_CHAIN_ID = process.env.NEXT_PUBLIC_SETTLEMENT_ENV === 'mainnet'
    ? NETWORKS.ARC_MAINNET.chainId
