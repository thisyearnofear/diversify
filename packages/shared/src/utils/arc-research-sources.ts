...
export const ARC_RESEARCH_SOURCE_REGISTRY: Record<string, ArcResearchSourceDefinition> = {
  ...
  sosovalue_macro_events: {
    ...
    freeLimit: 20,
    dataType: 'economic',
    fetchKey: 'sosovalue_macro_events',
    priority: 1,
    reputation: 0.85,
    freshnessWindowMinutes: 60,
  ...
  brightdata_central_banks: {
    ...
    label: 'Bright Data Central Bank Monitor',
    aliases: ['central-banks', 'fed-watch', 'ecb-watch', 'central-bank'],
    category: 'premium',
    price: '0.005',
    freeLimit: 2,
    dataType: 'economic',
    fetchKey: 'brightdata_central_banks',
    priority: 0,
    reputation: 0.90,
    freshnessWindowMinutes: 60,
    description: 'Live central bank announcements scraped via Bright Data — FOMC, ECB, BOE, BOJ, emerging market banks',
  },
  brightdata_commodities: {
    id: 'brightdata_commodities',
    label: 'Bright Data Commodity Prices',
    aliases: ['commodities', 'gold-price', 'oil-price', 'real-time-commodities'],
    category: 'premium',
    price: '0.004',
    freeLimit: 3,
    dataType: 'inflation',
    fetchKey: 'brightdata_commodities',
    priority: 1,
    reputation: 0.87,
    freshnessWindowMinutes: 5,
    description: 'Real-time commodity spot prices (gold, oil, copper, agricultural) scraped across regional markets via Bright Data Web Unlocker',
  },
  brightdata_financial_news: {
    id: 'brightdata_financial_news',
    label: 'Bright Data Financial News',
    aliases: ['financial-news', 'news-sentiment', 'market-news'],
    category: 'premium',
    price: '0.003',
    freeLimit: 5,
    dataType: 'sentiment',
    fetchKey: 'brightdata_financial_news',
    priority: 2,
    reputation: 0.82,
    freshnessWindowMinutes: 15,
    description: 'Regional financial news headlines and sentiment analysis scraped via Bright Data SERP — Reuters, Bloomberg, local sources',
  },
  brightdata_evidence_layer: {
    id: 'brightdata_evidence_layer',
    label: 'Bright Data Evidence Layer',
    aliases: ['evidence-layer', 'full-brightdata'],
    category: 'premium',
    price: '0.008',
    freeLimit: 1,
    dataType: 'economic',
    fetchKey: 'brightdata_evidence_layer',
    priority: 0,
    reputation: 0.91,
    freshnessWindowMinutes: 10,
    description: 'Full Bright Data evidence bundle — central bank announcements + commodity prices + financial news sentiment in one request',
  },
} as const;
