...
exports.OneInchSwapStrategy = void 0;
...
class OneInchSwapStrategy extends base_swap_strategy_1.BaseSwapStrategy {
    ...
    async getEstimate(params) {
        ...
        try {
            const quote = await this.getQuote({
                ...
                slippage: params.slippageTolerance || config_1.TX_CONFIG.DEFAULT_SLIPPAGE,
            });
            const expectedOutput = ethers_1.ethers.BigNumber.from(quote.dstAmount);
            ...
            // Estimate gas cost
            const gasCostEstimate = ethers_1.ethers.BigNumber.from(quote.gas || '0')
                .mul(ethers_1.ethers.BigNumber.from(quote.gasPrice || '0'));
            return {
    ...
    async execute(params, callbacks) {
        ...
        try {
            ...
            if (fromTokenAddress !== '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE') {
                const allowanceNeeded = await this.checkAndHandleApproval(fromTokenAddress, swapData.tx.to, amountInWei, signer, callbacks);
                if (!allowanceNeeded) {
...
exports.OneInchSwapStrategy = OneInchSwapStrategy;
//# sourceMappingURL=oneinch-swap.strategy.js.map