...
exports.NETWORK_OPTIMIZATION = exports.ONRAMP_PROVIDERS = void 0;
exports.getOnrampSystemPrompt = getOnrampSystemPrompt;
exports.getOnrampRecommendation = getOnrampRecommendation;
exports.ONRAMP_PROVIDERS = {
    guardarian: {
        name: "Guardarian",
        type: "primary",
        strengths: [
...
function getOnrampSystemPrompt() {
    return `
...
function getOnrampRecommendation(amount, network, userPreferences) {
...
exports.default = {
    ONRAMP_PROVIDERS: exports.ONRAMP_PROVIDERS,
    NETWORK_OPTIMIZATION: exports.NETWORK_OPTIMIZATION,
    getOnrampSystemPrompt,
    getOnrampRecommendation
};
//# sourceMappingURL=onramp-agent-context.js.map