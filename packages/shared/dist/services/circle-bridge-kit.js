...
exports.CircleBridgeKitService = void 0;
...
class CircleBridgeKitService {
     ...
     */
    async getBridgeQuote(sourceChainId, destinationChainId, amount, tokenAddress = config_1.ARC_DATA_HUB_CONFIG.USDC_TESTNET) {
        try {
            // Validate chains
     ...
     */
    async bridgeUSDC(sourceChainId, destinationChainId, amount, walletAddress, quoteId) {
        try {
            // Validate chains
            ...
            return {
                ...
                destinationChainId,
                amount,
                token: config_1.ARC_DATA_HUB_CONFIG.USDC_TESTNET,
     ...
     */
    async getBridgeTransactionStatus(transactionId) {
        // In real implementation, this would call Circle Bridge Kit API
        ...
        return {
            chains: [
                ...
                },
                {
                    ...
                    name: 'Arc Testnet',
                    nativeToken: 'USDC',
                    usdcAddress: config_1.ARC_DATA_HUB_CONFIG.USDC_TESTNET
                }
            ],
            tokens: [
                {
...
exports.CircleBridgeKitService = CircleBridgeKitService;
//# sourceMappingURL=circle-bridge-kit.js.map