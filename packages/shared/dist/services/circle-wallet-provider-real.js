...
exports.RealCircleWalletProvider = void 0;
...
class RealCircleWalletProvider {
    ...
    async balanceOf(tokenAddress) {
        ...
        try {
            ...
            const tokenBalance = balances.find((b) => b.token?.tokenAddress?.toLowerCase() === tokenAddress.toLowerCase());
            if (!tokenBalance) {
                return 0;
            }
     ...
     */
    async pollTransactionStatus(txId, maxAttempts = 30) {
        let attempts = 0;
     ...
     */
    async estimateFee(to, amount, tokenAddress) {
        this.ensureInitialized();
        try {
...
exports.RealCircleWalletProvider = RealCircleWalletProvider;
//# sourceMappingURL=circle-wallet-provider-real.js.map