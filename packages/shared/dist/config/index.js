...
exports.hasAutonomousFeatures = exports.hasAIFeatures = exports.WALLET_FEATURES = exports.UI_FEATURES = exports.AUTONOMOUS_FEATURES = exports.AI_FEATURES = exports.TESTNET_CHAIN_IDS = exports.BROKER_ADDRESSES = exports.RH_TESTNET_TOKENS = exports.ARC_TOKENS = exports.ARBITRUM_TOKENS = exports.CELO_SEPOLIA_TOKENS = exports.MAINNET_TOKENS = exports.SWAP_CONFIG = exports.CACHE_CONFIG = exports.ABIS = exports.CIRCLE_CONFIG = exports.TX_CONFIG = exports.EXCHANGE_RATES = exports.NETWORK_TOKENS = exports.TOKEN_METADATA = exports.REGION_GRADIENT_TEXT = exports.REGION_GRADIENTS = exports.REGION_COLORS = exports.ASSET_REGION_LIST = exports.ASSET_CATEGORY_LIST = exports.GEOGRAPHIC_REGION_LIST = exports.REGIONS = exports.ASSET_CATEGORIES = exports.GEOGRAPHIC_REGIONS = exports.ARC_DATA_HUB_CONFIG = exports.NETWORKS = void 0;
exports.getTokenApy = getTokenApy;
exports.isTokenInflationHedge = isTokenInflationHedge;
exports.getTokenRegion = getTokenRegion;
exports.getChainAssets = getChainAssets;
exports.getTokenAddresses = getTokenAddresses;
exports.getBrokerAddress = getBrokerAddress;
...
exports.GEOGRAPHIC_REGION_LIST = ['USA', 'Europe', 'LatAm', 'Africa', 'Asia'];
exports.ASSET_CATEGORY_LIST = ['Global', 'Commodities'];
exports.ASSET_REGION_LIST = [...exports.GEOGRAPHIC_REGION_LIST, ...exports.ASSET_CATEGORY_LIST];
// Colors for visualization (canonical, no duplicates)
exports.REGION_COLORS = {
    USA: '#3B82F6', // Blue
    Europe: '#22C55E', // Green
    LatAm: '#F59E0B', // Amber
    Africa: '#EF4444', // Red
...
exports.TOKEN_METADATA = {
    ...
    USDm: { name: 'Mento Dollar', region: exports.REGIONS.USA },
    EURm: { name: 'Mento Euro', region: exports.REGIONS.EUROPE },
    BRLm: { name: 'Mento Brazilian Real', region: exports.REGIONS.LATAM },
    KESm: { name: 'Mento Kenyan Shilling', region: exports.REGIONS.AFRICA },
    COPm: { name: 'Mento Colombian Peso', region: exports.REGIONS.LATAM },
    PHPm: { name: 'Mento Philippine Peso', region: exports.REGIONS.ASIA },
    GHSm: { name: 'Mento Ghana Cedi', region: exports.REGIONS.AFRICA },
    XOFm: { name: 'Mento CFA Franc', region: exports.REGIONS.AFRICA },
    GBPm: { name: 'Mento British Pound', region: exports.REGIONS.EUROPE },
    ZARm: { name: 'Mento South African Rand', region: exports.REGIONS.AFRICA },
    CADm: { name: 'Mento Canadian Dollar', region: exports.REGIONS.USA },
    AUDm: { name: 'Mento Australian Dollar', region: exports.REGIONS.ASIA },
    CHFm: { name: 'Swiss Franc', region: exports.REGIONS.EUROPE },
    JPYm: { name: 'Mento Japanese Yen', region: exports.REGIONS.ASIA },
    NGNm: { name: 'Mento Nigerian Naira', region: exports.REGIONS.AFRICA },
    // UBI Token
    'G$': { name: 'GoodDollar', region: exports.REGIONS.GLOBAL, decimals: 18, apy: null, isInflationHedge: false },
    // Global Stablecoins (no yield, low inflation exposure)
    USDT: { name: 'Tether USD', region: exports.REGIONS.USA, decimals: 6 },
    USDC: { name: 'USD Coin', region: exports.REGIONS.GLOBAL, decimals: 6 },
    EURC: { name: 'Euro Coin', region: exports.REGIONS.EUROPE, decimals: 6 },
    // Yield-Bearing Assets (Arbitrum RWAs)
    USDY: { name: 'Ondo US Dollar Yield', region: exports.REGIONS.USA, decimals: 18, apy: 5.0 },
    SYRUPUSDC: { name: 'Syrup USDC', region: exports.REGIONS.USA, decimals: 18, apy: 4.5 },
    // Inflation Hedges (store of value, no yield)
    PAXG: { name: 'Pax Gold', region: exports.REGIONS.COMMODITIES, decimals: 18, apy: 0, isInflationHedge: true },
    // Native ETH (used as quote token on Robinhood Chain)
    ETH: { name: 'Ether', region: exports.REGIONS.GLOBAL, decimals: 18, apy: 0 },
    // Fictional Stock Tokens (Robinhood Chain Testnet)
    ACME: { name: 'Acme Corporation', region: exports.REGIONS.USA, decimals: 18, apy: 0 },
    SPACELY: { name: 'Spacely Sprockets', region: exports.REGIONS.USA, decimals: 18, apy: 0 },
    WAYNE: { name: 'Wayne Industries', region: exports.REGIONS.USA, decimals: 18, apy: 0 },
    OSCORP: { name: 'Oscorp Industries', region: exports.REGIONS.USA, decimals: 18, apy: 0 },
    STARK: { name: 'Stark Industries', region: exports.REGIONS.USA, decimals: 18, apy: 0 },
    // Fictional Emerging Market Companies (Celo Sepolia Testnet)
    // Africa
    WAKANDA: { name: 'Wakanda Design Group', region: exports.REGIONS.AFRICA, decimals: 18, apy: 0 },
    DAKAR: { name: 'Dakar Nexus Energy', region: exports.REGIONS.AFRICA, decimals: 18, apy: 0 },
    SHADOW: { name: 'Shadow Market Syndicates', region: exports.REGIONS.AFRICA, decimals: 18, apy: 0 },
    // Latin America / Asia
    KUBERA: { name: "Kubera's Treasury Guilds", region: exports.REGIONS.ASIA, decimals: 18, apy: 0 },
    SANTA: { name: 'Santa Prisca Silver Mining', region: exports.REGIONS.LATAM, decimals: 18, apy: 0 },
    SHADALOO: { name: 'Shadaloo Corporation', region: exports.REGIONS.ASIA, decimals: 18, apy: 0 },
    // Asia Pacific
    MISHIMA: { name: 'Mishima Zaibatsu', region: exports.REGIONS.ASIA, decimals: 18, apy: 0 },
    ARASAKA: { name: 'Arasaka Corporation', region: exports.REGIONS.ASIA, decimals: 18, apy: 0 },
    SURA: { name: 'Sura Corporation', region: exports.REGIONS.ASIA, decimals: 18, apy: 0 },
};
// Helper to get token yield (0 if none)
function getTokenApy(symbol) {
    const normalized = symbol.toUpperCase();
    return exports.TOKEN_METADATA[normalized]?.apy ?? 0;
}
// Helper to check if token is an inflation hedge
function isTokenInflationHedge(symbol) {
    const normalized = symbol.toUpperCase();
    return exports.TOKEN_METADATA[normalized]?.isInflationHedge ?? false;
}
// Helper to get token region (normalized)
function getTokenRegion(symbol) {
    const normalized = symbol.toUpperCase();
    return exports.TOKEN_METADATA[normalized]?.region ?? exports.REGIONS.GLOBAL;
}
// Single Source of Truth for Network Assets
exports.NETWORK_TOKENS = {
    [exports.NETWORKS.CELO_MAINNET.chainId]: ['USDm', 'EURm', 'BRLm', 'KESm', 'COPm', 'PHPm', 'GHSm', 'XOFm', 'GBPm', 'ZARm', 'CADm', 'AUDm', 'CHFm', 'JPYm', 'NGNm', 'G$', 'USDT'],
    [exports.NETWORKS.CELO_SEPOLIA.chainId]: ['USDm', 'EURm', 'BRLm', 'XOFm', 'KESm', 'PHPm', 'COPm', 'GHSm', 'GBPm', 'ZARm', 'CADm', 'AUDm', 'G$', 'USDT', 'CELO', 'WAKANDA', 'DAKAR', 'SHADOW', 'KUBERA', 'SANTA', 'SHADALOO', 'MISHIMA', 'ARASAKA', 'SURA'],
    [exports.NETWORKS.ARBITRUM_ONE.chainId]: ['USDC', 'PAXG', 'USDY', 'SYRUPUSDC'],
    [exports.NETWORKS.ARC_TESTNET.chainId]: ['USDC', 'EURC'],
    [exports.NETWORKS.RH_TESTNET.chainId]: ['ETH', 'ACME', 'SPACELY', 'WAYNE', 'OSCORP', 'STARK'],
};
// Helper: Get full asset list with metadata for a specific chain
function getChainAssets(chainId) {
    const symbols = exports.NETWORK_TOKENS[chainId] || exports.NETWORK_TOKENS[exports.NETWORKS.CELO_MAINNET.chainId];
    return symbols.map(symbol => ({
        symbol,
        name: exports.TOKEN_METADATA[symbol]?.name || symbol,
        region: exports.TOKEN_METADATA[symbol]?.region || exports.REGIONS.GLOBAL
    }));
}
...
exports.SWAP_CONFIG = {
    STRATEGY_SCORES: {
        [exports.NETWORKS.CELO_MAINNET.chainId]: { 'MentoSwapStrategy': 100, 'OneInchSwapStrategy': 20, 'UniswapV3Strategy': 15, 'LiFiSwapStrategy': 40 },
        [exports.NETWORKS.CELO_SEPOLIA.chainId]: { 'MentoSwapStrategy': 100, 'LiFiSwapStrategy': 20 },
        [exports.NETWORKS.ARC_TESTNET.chainId]: { 'CurveArcStrategy': 100, 'ArcTestnetStrategy': 90 },
        [exports.NETWORKS.ARBITRUM_ONE.chainId]: { 'OneInchSwapStrategy': 90, 'UniswapV3Strategy': 80, 'LiFiSwapStrategy': 60, 'DirectRWAStrategy': 30 },
    },
    TOKEN_PREFERENCES: {
...
function getTokenAddresses(chainId) {
    if (chainId === exports.NETWORKS.RH_TESTNET.chainId)
        return exports.RH_TESTNET_TOKENS;
    if (chainId === exports.NETWORKS.ARC_TESTNET.chainId)
        return exports.ARC_TOKENS;
    if (chainId === exports.NETWORKS.ARBITRUM_ONE.chainId)
        return exports.ARBITRUM_TOKENS;
    return chainId === exports.NETWORKS.CELO_SEPOLIA.chainId ? exports.CELO_SEPOLIA_TOKENS : exports.MAINNET_TOKENS;
}
function getBrokerAddress(chainId) {
    if (chainId === exports.NETWORKS.ARBITRUM_ONE.chainId)
        return '0x0000000000000000000000000000000000000000';
    return chainId === exports.NETWORKS.CELO_SEPOLIA.chainId ? '0xD3Dff18E465bCa6241A244144765b4421Ac14D09' : '0x777a8255ca72412f0d706dc03c9d1987306b4cad';
}
function getNetworkConfig(chainId) {
    return Object.values(exports.NETWORKS).find(n => n.chainId === chainId) || exports.NETWORKS.CELO_MAINNET;
}
// =============================================================================
...
exports.TESTNET_CHAIN_IDS = Object.values(exports.NETWORKS)
    .filter((n) => n.devOnly === true)
    .map(n => n.chainId);
/** Returns true when chainId belongs to a testnet / devOnly network. */
function isTestnetChain(chainId) {
    if (chainId == null)
        return false;
    return exports.TESTNET_CHAIN_IDS.includes(chainId);
}
// Re-export features for convenience
var features_1 = require("./features");
Object.defineProperty(exports, "AI_FEATURES", { enumerable: true, get: function () { return features_1.AI_FEATURES; } });
Object.defineProperty(exports, "AUTONOMOUS_FEATURES", { enumerable: true, get: function () { return features_1.AUTONOMOUS_FEATURES; } });
Object.defineProperty(exports, "UI_FEATURES", { enumerable: true, get: function () { return features_1.UI_FEATURES; } });
Object.defineProperty(exports, "WALLET_FEATURES", { enumerable: true, get: function () { return features_1.WALLET_FEATURES; } });
Object.defineProperty(exports, "hasAIFeatures", { enumerable: true, get: function () { return features_1.hasAIFeatures; } });
Object.defineProperty(exports, "hasAutonomousFeatures", { enumerable: true, get: function () { return features_1.hasAutonomousFeatures; } });
