export declare const STREAK_STORAGE_KEY: "diversifi_streak_v1";
export declare const STREAK_CONFIG: {
    readonly MIN_SWAP_USD: 1;
    readonly GRACE_PERIODS_PER_WEEK: 1;
    readonly G_CLAIM_URL: "http://goodwallet.xyz?inviteCode=4AJXLg3ynL";
    readonly G_TOKEN_ADDRESS: "0x62B8B11039FcfE5aB0C56E502b1C372A3d2a9c7A";
};
