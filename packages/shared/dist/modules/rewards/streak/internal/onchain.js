...
exports.fetchOnChainStatus = fetchOnChainStatus;
async function fetchOnChainStatus(address) {
    let onChainStatus = {
        isWhitelisted: true,
        entitlement: '0',
    ...
    try {
        const { GoodDollarService } = await Promise.resolve().then(() => __importStar(require('../../../../services/gooddollar-service')));
