...
exports.SETUP_INSTRUCTIONS = void 0;
exports.generateAgentPrivateKey = generateAgentPrivateKey;
exports.validateAgentConfig = validateAgentConfig;
exports.getArcNetworkConfig = getArcNetworkConfig;
exports.formatUSDC = formatUSDC;
exports.checkX402Support = checkX402Support;
...
function validateAgentConfig() {
    ...
    if (!process.env.ARC_AGENT_PRIVATE_KEY) {
        ...
        try {
            const wallet = new ethers_1.ethers.Wallet(process.env.ARC_AGENT_PRIVATE_KEY);
    ...
    if (dataHubWallet) {
        try {
            ethers_1.ethers.utils.getAddress(dataHubWallet);
        }
        catch {
 ...
 */
async function checkX402Support(url) {
    try {
...
//# sourceMappingURL=arc-agent-setup.js.map