...
exports.COUNTRY_NAMES = exports.PRIORITY_COUNTRIES = exports.CURRENCY_TO_COUNTRY = exports.COUNTRY_TO_REGION = exports.INFLATION_DATA_SOURCES = exports.FALLBACK_INFLATION_DATA = void 0;
exports.getFallbackByRegion = getFallbackByRegion;
exports.FALLBACK_INFLATION_DATA = {
    Africa: {
        avgRate: 12.5,
        data: [
            { year: 2020, rate: 11.8 },
...
exports.INFLATION_DATA_SOURCES = {
    PRIMARY: 'IMF',
    SECONDARY: 'WorldBank',
...
function getFallbackByRegion() {
    const result = {};
    for (const [region, data] of Object.entries(exports.FALLBACK_INFLATION_DATA)) {
            ...
            for (const entry of data.data) {
                ...
                if (data.countries) {
                    for (const countryCode of data.countries) {
                        countries.push({
                            country: exports.COUNTRY_NAMES[countryCode] || countryCode,
                            region: region,
                            currency: exports.CURRENCY_TO_COUNTRY[countryCode] || 'Unknown',
                            value: entry.rate,
                            year: entry.year
                        });
                    }
