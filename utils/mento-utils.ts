...
export const MENTO_ABIS = {
  ERC20_FULL: ABIS.ERC20,
  ERC20_BALANCE: ABIS.ERC20,
  ERC20_ALLOWANCE: ABIS.ERC20,
  ERC20_APPROVE: ABIS.ERC20,
  BROKER_PROVIDERS: ABIS.BROKER.PROVIDERS,
  EXCHANGE: ABIS.EXCHANGE,
  BROKER_RATE: ABIS.BROKER.RATE,
  BROKER_SWAP: ABIS.BROKER.SWAP,
};
